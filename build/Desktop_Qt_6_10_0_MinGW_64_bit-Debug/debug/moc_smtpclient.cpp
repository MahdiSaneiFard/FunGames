...
#include "../../../Project/FunGames/smtp/src/smtpclient.h"
...
template <> constexpr inline auto SmtpClient::qt_create_metaobjectdata<qt_meta_tag_ZN10SmtpClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'AuthMethod'
        QtMocHelpers::EnumData<enum AuthMethod>(21, 21, QMC::EnumFlags{}).add({
            {   22, AuthMethod::AuthPlain },
            {   23, AuthMethod::AuthLogin },
        }),
        // enum 'SmtpError'
        QtMocHelpers::EnumData<enum SmtpError>(24, 24, QMC::EnumFlags{}).add({
        ...
        // enum 'ConnectionType'
        QtMocHelpers::EnumData<enum ConnectionType>(32, 32, QMC::EnumFlags{}).add({
            {   33, ConnectionType::TcpConnection },
            {   34, ConnectionType::SslConnection },
            {   35, ConnectionType::TlsConnection },
        }),
        // enum 'ClientState'
        QtMocHelpers::EnumData<enum ClientState>(36, 36, QMC::EnumFlags{}).add({
