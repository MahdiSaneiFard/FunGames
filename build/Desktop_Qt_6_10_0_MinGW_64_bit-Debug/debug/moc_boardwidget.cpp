...
#include "../../../Project/FunGames/boardwidget.h"
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BoardWidget::*)(int )>(_a, &BoardWidget::columnClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void BoardWidget::columnClicked(int _t1)
{
