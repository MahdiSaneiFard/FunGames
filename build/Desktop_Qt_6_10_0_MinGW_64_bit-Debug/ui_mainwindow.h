...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        activeMatchesTableWidget = new QTableWidget(groupBox_2);
        activeMatchesTableWidget->setObjectName("activeMatchesTableWidget");
        activeMatchesTableWidget->setEnabled(false);
        ...
        JoinPushButton = new QPushButton(groupBox_2);
